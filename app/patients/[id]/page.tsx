    ...
    <div className="max-w-lg mx-auto py-10 px-4">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 p-6 mb-4">
        <div className="flex items-center gap-4 mb-5">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 bg-[linear-gradient(135deg,#0B82C6,#00A482)]">
        ...
        <div className="mb-5">
          <div className="flex">
            <div className="flex-1">
              ...
              <p className="font-semibold text-slate-800">{patient.age} лет</p>
            </div>
          ...
          {patient.notes && (
            <div className="mt-4 pt-4 border-t border-slate-100">
              ...
              <p className="font-semibold text-slate-800">{patient.notes}</p>
            </div>
          )}
        </div>
